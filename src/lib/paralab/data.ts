...
export const SENSORS: SensorDef[] = [
  ...
  {
    id: "gas",
    label: "Detektor Gas Mudah Terbakar",
    unit: "%LEL",
    grup: "Utilitas & Keselamatan",
    base: 2,
    jitter: 1.2,
...
export const BAHAN_LIBRARY: Ingredient[] = [
  ...
  bahan(
    "propanediol",
    "Propanediol Fermentasi",
    "Propanediol",
    "A",
    "Humektan dan booster pengawet",
    3,
    88000,
    {
      golongan: "Humektan",
  ...
  bahan(
    ...
    "Pentylene Glycol",
    "A",
    "Pelarut dan antimikroba ringan",
    2,
    210000,
    {
      golongan: "Humektan",
  ...
  bahan(
    "niacinamide",
    "Niacinamide USP Kadar Rendah Asam Nikotinat",
    "Niacinamide",
    "A",
    "Pencerah dan pengendali sebum",
    4,
    480000,
    {
      ...
      inkompatibel:
        "Asam askorbat bebas pada pH rendah, hidrolisis menjadi asam nikotinat pemicu flushing",
  ...
  bahan(
    "niacinamide_hp",
    "Niacinamide Kadar Tinggi 10 Persen",
    "Niacinamide",
    "A",
    "Pencerah intensif",
    10,
    520000,
    {
      ...
      inkompatibel:
        "Risiko flushing meningkat, wajib kontrol asam nikotinat bebas di bawah 100 ppm",
  ...
  bahan(
    ...
    "Sodium Ascorbyl Phosphate",
    "C",
    "Antioksidan stabil turunan vitamin C",
    2,
    1450000,
    {
      ...
      spesifikasi:
        "Kadar minimal 95 persen, warna larutan tidak lebih tua dari standar kuning muda",
    },
  ),
  bahan(
    "map",
    ...
    "Magnesium Ascorbyl Phosphate",
    "C",
    "Pencerah lembut turunan vitamin C",
    3,
    1680000,
    {
      golongan: "Turunan vitamin C",
  ...
  bahan(
    "peptide_matrixyl",
    "Peptida Matrixyl 3000",
    "Palmitoyl Tripeptide-1",
    "C",
    "Peptida sinyal kolagen",
    3,
    4800000,
    {
      golongan: "Peptida",
  ...
  bahan(
    "argireline",
    "Peptida Relaksasi Otot",
    "Acetyl Hexapeptide-8",
    "C",
    "Mengurangi garis halus ekspresi",
    5,
    5200000,
    {
      golongan: "Peptida",
  ...
  bahan(
    ...
    "Lactic Acid",
    "C",
    "Eksfoliasi lembut dan pelembap",
    5,
    96000,
    {
      golongan: "Alfa hidroksi asam",
  ...
  bahan(
    "hyaluronic",
    "Natrium Hialuronat Bobot Sedang",
    "Sodium Hyaluronate",
    "C",
    "Pelembap pengikat air",
    0.5,
    2100000,
    {
  ...
  bahan(
    "ha_low",
    "Hialuronat Bobot Rendah",
    "Hydrolyzed Sodium Hyaluronate",
    "C",
    "Pelembap lapis dalam",
    0.3,
    2650000,
    {
      golongan: "Pelembap polimer",
  ...
  bahan(
    "madu_ekstrak",
    "Ekstrak Madu Terfermentasi",
    "Honey Extract",
    "C",
    "Humektan dan antioksidan alami",
    1,
    780000,
    {
      golongan: "Ekstrak botani",
  ...
  bahan(
    "gms",
    "Gliseril Monostearat SE",
    "Glyceryl Stearate SE",
    "B",
    "Emulsifier minyak dalam air",
    2.5,
    76000,
    {
      golongan: "Emulsifier",
  ...
  bahan(
    "sepimax",
    "Polimer Toleran Elektrolit",
    "Polyacrylate Crosspolymer-6",
    "D",
    "Pengental toleran garam",
    1,
    640000,
    {
      golongan: "Polimer sintetis",
  ...
  bahan(
    "titanium",
    "Titanium Dioxide Terlapis",
    "Titanium Dioxide",
    "B",
    "Perlindungan UVB fisik",
    6,
    185000,
    {
      golongan: "Filter UV mineral",
  ...
  bahan(
    ...
    "Ferulic Acid",
    "C",
    "Antioksidan penstabil vitamin C",
    0.5,
    2450000,
    {
      golongan: "Antioksidan",
  ...
  bahan(
    "naoh",
    "Larutan Natrium Hidroksida 10 Persen",
    "Sodium Hydroxide",
    "D",
    "Penyesuai pH basa",
    0.2,
...
export const CLASH_RULES: ClashRule[] = [
  {
    ...
    b: "niacinamide",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-001",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-001",
    perluTinjauanManusia: false,
    alasan:
      "Pada pH rendah dapat membentuk niacin yang memicu kemerahan, pisahkan fase atau jaga pH di atas 5",
  },
  {
    a: "retinol",
    b: "aha",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-002",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-002",
    perluTinjauanManusia: true,
    alasan: "Kombinasi eksfolian kuat meningkatkan risiko iritasi dan merusak stabilitas retinol",
  },
  {
    a: "retinol",
    b: "salicylic",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-003",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-003",
    perluTinjauanManusia: true,
    alasan: "Beban eksfoliasi berlebih untuk produk leave on harian",
  },
  {
    a: "carbomer",
    b: "zinc",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-004",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-004",
    perluTinjauanManusia: false,
    alasan: "Elektrolit tinggi menurunkan viskositas gel karbomer",
  },
  {
    a: "vitc",
    b: "kojic",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-005",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-005",
    perluTinjauanManusia: false,
    alasan: "Dua bahan rentan oksidasi, warna produk cepat menguning",
  },
  {
    a: "aha",
    b: "tea",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-006",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-006",
    perluTinjauanManusia: false,
    alasan: "Netralisasi berlebih membuat pH keluar dari jendela kerja asam",
  },
  {
    a: "laa",
    b: "niacinamide",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-007",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-007",
    perluTinjauanManusia: true,
    alasan:
      "Asam askorbat bebas dan niacinamide pada pH di bawah 4 membentuk kompleks kuning dan asam nikotinat pemicu flushing",
  },
  {
    a: "laa",
    b: "copper_peptide",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-008",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-008",
    perluTinjauanManusia: true,
    alasan: "Vitamin C mereduksi kompleks tembaga sehingga peptida kehilangan aktivitas",
  },
  {
    a: "laa",
    b: "edta",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-009",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-009",
    perluTinjauanManusia: false,
    alasan: "Kelator dibutuhkan, namun rasio harus dihitung agar tidak mengganggu kestabilan warna",
  },
  {
    a: "arbutin",
    b: "aha",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-010",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-010",
    perluTinjauanManusia: true,
    alasan: "pH asam menghidrolisis arbutin menjadi hidrokuinon yang dilarang",
  },
  {
    a: "benzoyl",
    b: "retinol",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-011",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-011",
    perluTinjauanManusia: true,
    alasan: "Peroksida mengoksidasi retinol sehingga potensi hilang dalam hitungan jam",
  },
  {
    a: "benzoyl",
    b: "laa",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-012",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-012",
    perluTinjauanManusia: true,
    alasan: "Oksidasi silang membuat warna berubah dan kedua aktif terdegradasi",
  },
  {
    a: "retinal",
    b: "aha",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-013",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-013",
    perluTinjauanManusia: true,
    alasan: "Gugus aldehid tidak stabil pada pH rendah dan beban iritasi bertambah",
  },
  {
    a: "peptide_matrixyl",
    b: "aha",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-014",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-014",
    perluTinjauanManusia: false,
    alasan: "pH rendah memutus rantai peptida sehingga klaim anti penuaan tidak tercapai",
  },
  {
    a: "carbomer",
    b: "sci",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-015",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-015",
    perluTinjauanManusia: false,
    alasan: "Surfaktan anionik dan elektrolit menurunkan viskositas gel karbomer secara tajam",
  },
  {
    a: "carbomer",
    b: "niacinamide_hp",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-016",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-016",
    perluTinjauanManusia: false,
    alasan: "Kadar aktif tinggi menambah beban ionik, gunakan polimer toleran elektrolit",
  },
  {
    a: "avobenzone",
    b: "zinc_oxide",
    tingkat: "tinggi",
    ruleId: "WEB-COMPAT-017",
    ruleVersion: RULE_VERSION,
    severity: "blocked",
    sourceId: "WEB-RULESRC-017",
    perluTinjauanManusia: true,
    alasan: "Zinc oxide mempercepat fotodegradasi avobenzone, butuh pelapis atau filter pengganti",
  },
  {
    a: "avobenzone",
    b: "niacin_sunscreen",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-018",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-018",
    perluTinjauanManusia: false,
    alasan: "Pasangan ini cepat kehilangan SPF tanpa fotostabilizer seperti Tinosorb S",
  },
  {
    a: "sodium_benzoate",
    b: "laa",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-019",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-019",
    perluTinjauanManusia: false,
    alasan: "Kombinasi berpotensi membentuk benzena jejak, hindari atau ganti pengawet",
  },
  {
    a: "urea",
    b: "naoh",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-020",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-020",
    perluTinjauanManusia: false,
    alasan: "pH tinggi menghidrolisis urea menjadi amonia sehingga aroma berubah",
  },
  {
    a: "map",
    b: "zinc",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-021",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-021",
    perluTinjauanManusia: false,
    alasan: "Ion divalen mengendapkan turunan askorbil fosfat",
  },
  {
    a: "kolagen",
    b: "aha",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-022",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-022",
    perluTinjauanManusia: false,
    alasan: "Hidrolisis lanjutan protein pada pH rendah menimbulkan bau dan kekeruhan",
  },
  {
    a: "tea_tree",
    b: "carbomer",
    tingkat: "sedang",
    ruleId: "WEB-COMPAT-023",
    ruleVersion: RULE_VERSION,
    severity: "warning",
    sourceId: "WEB-RULESRC-023",
    perluTinjauanManusia: false,
    alasan: "Minyak esensial tanpa solubilizer membuat gel keruh dan berpisah",
  },
];
...
export const SEED_PROJECTS: Project[] = [
  {
    ...
    update: jam(7),
    brief:
      "Studi simulasi pengembangan pembersih wajah pada kategori publik Varko untuk kulit berminyak pria aktif. Formula dan hasil uji pada aplikasi bukan data produk komersial.",
    ...
    batches: [
      {
        ...
        prosedur: [
          "Larutkan fase A pada 75 C",
          "Lelehkan fase B pada 75 C",
          "Homogenisasi 3200 rpm selama 8 menit",
          "Dinginkan ke 40 C lalu tambahkan fase C dan D",
        ],
        bahan: bahanDari([
          "aqua",
          "glycerin",
        ...
        evaluasi: {
          ringkasan:
            "Batch 1 mencapai kontrol minyak yang baik namun kestabilan emulsi belum memenuhi target.",
          kekurangan: [
            "pH 0.5 unit di atas target",
            "Viskositas di bawah batas bawah",
            "Droplet terlalu besar sehingga rentan koalesensi",
          ],
          rekomendasi: [
            "Naikkan cetearyl alcohol menjadi 4 persen",
            "Tambahkan fase asam untuk menurunkan pH",
            "Perpanjang homogenisasi menjadi 10 menit",
          ],
          perubahanFormula: [
            {
              bahan: "Cetearyl Alcohol",
              dari: 3,
              ke: 4,
              alasan: "Menaikkan viskositas ke jendela target",
            },
          ...
          rancanganBerikutnya: {
            ...
            hipotesis:
              "Penambahan pengental dan penurunan pH akan memperkecil droplet di bawah 3.5 um.",
          },
          skorKesesuaian: 68,
        },
      },
      {
        ...
        hipotesis:
          "Penambahan pengental dan penurunan pH akan memperkecil droplet di bawah 3.5 um.",
        prosedur: [
          "Ulangi prosedur batch 1 dengan cetearyl 4 persen",
          "Homogenisasi 3400 rpm selama 10 menit",
          "Uji sentrifugasi 3000 rpm 30 menit",
        ],
        bahan: bahanDari(
          [
            "aqua",
  ...
  },
  {
    ...
    update: jam(5),
    brief:
      "Studi simulasi kategori serum pencerah Amarya dengan fokus sensori ringan, tidak lengket, dan kompatibilitas niacinamide. Formula bukan formula produk komersial.",
    targets: TARGET_PRESET,
    batches: [
      {
        nomor: 1,
        ...
        prosedur: [
          "Larutkan bahan aktif ke fase air",
          "Aduk 600 rpm selama 15 menit",
          "Sesuaikan pH ke 5.5",
        ],
        bahan: bahanDari([
          "aqua",
        ...
        evaluasi: {
          ringkasan:
            "Formula memenuhi kejernihan dan pH target, isu tersisa hanya sensori lengket.",
          kekurangan: ["Sensasi lengket 40 detik pertama", "Belum ada uji stabilitas cahaya"],
          rekomendasi: [
            "Turunkan butylene glycol ke 2 persen",
            "Tambahkan uji paparan cahaya 7 hari",
          ],
          perubahanFormula: [
            { bahan: "Butylene Glycol", dari: 3, ke: 2, alasan: "Mengurangi rasa lengket" },
          ],
          rancanganBerikutnya: {
            tujuan: [
              "Menghilangkan sensasi lengket",
              "Memastikan warna stabil setelah paparan cahaya",
            ],
  ...
  },
  {
    ...
    update: jam(4),
    brief:
      "Studi simulasi kategori perlindungan matahari Amarya untuk iklim tropis dengan tekstur ringan dan target residu putih rendah.",
    targets: TARGET_PRESET,
    batches: [
      {
        nomor: 1,
        ...
        prosedur: [
          "Dispersikan zinc oxide ke fase minyak",
          "Giling 3 siklus",
          "Emulsifikasi pada 70 C",
        ],
        bahan: bahanDari([
          "aqua",
          "zinc_oxide",
  ...
  },
  {
    ...
    update: jam(3),
    brief:
      "Studi simulasi kategori toner Zevi dengan asam glikolat kadar rendah untuk kulit kombinasi. Keamanan klaim tetap memerlukan pengujian terkontrol.",
    targets: TARGET_PRESET,
    batches: [
      {
        nomor: 1,
        ...
        evaluasi: {
          ...
          perubahanFormula: [],
          rancanganBerikutnya: {
            tujuan: ["Uji pemakaian 28 hari"],
            fokusUji: ["Iritasi", "pH"],
            hipotesis: "Formula stabil sepanjang uji pemakaian.",
          },
          skorKesesuaian: 93,
        },
      },
  ...
  },
  {
    ...
    update: jam(2),
    brief:
      "Studi simulasi kategori body lotion Amarya dengan target hidrasi 24 jam dan profil sensori yang sesuai untuk iklim tropis.",
    targets: TARGET_PRESET,
    batches: [],
  },
];
...
export function lengkapiBahan(b: Ingredient): Ingredient {
  ...
  return {
    ...
    ...b,
    percent: b.percent,
    phKerja: b.phKerja ?? ref?.phKerja ?? dasar.phKerja,
    dosis: b.dosis ?? ref?.dosis ?? dasar.dosis,
  };
}
