  ...
  head: () => ({
    meta: [
      { title: "Kirim Hasil Penelitian ke Divisi | paralab.ai" },
      {
        name: "description",
        content:
          "Ringkasan serah terima formula final, HPP, status halal, dan hasil parameter sensor untuk divisi produksi, regulatori, dan pemasaran.",
      },
      { property: "og:title", content: "Kirim Hasil Penelitian ke Divisi | paralab.ai" },
      {
        property: "og:description",
        content: "Serah terima hasil riset formulasi antar divisi dalam satu berkas ringkas.",
      },
...
function HandoffPage() {
  ...
  function kirim() {
    const tujuan = divisi;
    actions.perbaruiProyek(proyek!.id, (p) => ({
      ...p,
    ...
    actions.catat(
      ...
      proyek!.judul,
      "Serah terima",
      "Hasil batch " + batchTerakhir.nomor + " dikirim ke " + tujuan,
    );
    setTerkirim(true);
  }
  ...
  return (
    <AppShell
      judul="Kirim ke divisi terkait"
      deskripsi={"Serah terima hasil penelitian " + proyek.judul}
    >
      <StatStrip>
        <Stat
          label="Batch terakhir"
          value={"Batch " + batchTerakhir.nomor}
          hint={batchTerakhir.status}
        />
        <Stat label="Skor kesesuaian" value={skor + " persen"} hint="Terhadap standar output" />
        <Stat
          label="Parameter lolos"
          value={lolos + " dari " + proyek.targets.length}
          hint="Diverifikasi sensor laboratorium"
        />
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardTitle
            title="Ringkasan serah terima"
            sub="Berkas ini otomatis disusun dari jurnal praktikum dan pembacaan sensor."
          />
                    ...
                    >
                      ...
                      <span className="flex items-center gap-2">
                        ...
                        {ok ? (
                          ...
                          <Pill variant="waspada">tinjau</Pill>
                        )}
                      </span>
                    </li>
                  );
          ...
          {terkirim ? (
            <div className="rounded-xl bg-success-soft p-4">
              ...
              <p className="mt-1.5 text-sm text-foreground">
                Penelitian ini berstatus menunggu tinjauan {proyek.dikirimKe}. Notifikasi sudah
                tercatat pada logbook laboratorium.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="rounded-xl bg-secondary p-3 text-xs text-muted-foreground">
                Berkas dikirim ke {divisi} beserta lampiran formula, hasil sensor, dan catatan
                kepatuhan.
              </p>
              ...
              <Field label="Pesan untuk divisi">
                <textarea
                  ...
                  placeholder="Contoh: mohon verifikasi kelayakan produksi skala 500 kg."
                />
              </Field>
              ...
              {skor < 70 && (
                <p className="text-xs text-muted-foreground">
                  Selesaikan dan evaluasi batch hingga skor kesesuaian minimal 70 persen sebelum
                  mengirim.
                </p>
              )}
            </div>
